...
simulation<-function(n=3000, p = 5, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 1){
...
for( i in 1:times ){
    ...
    variance = NULL; output=NULL; truth = NULL
    ...
    if(func=='exp'){Z.tr.res = pmax(Z.tr.res,0.001)}
...
#write.csv(output, paste("/Users/lmy/Dropbox/Mingyang-HLi/projects/survival_random_forest/Revision_material/code for Table2/", func, '_', 'model', model, '_', p, 'test.csv', sep = ""), row.names = FALSE)

}


simulation(n=3000, p = 5, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 1)
simulation(n=3000, p = 5, L=5.3, hazardC=0.08, SNR=0.3, func='id',  times=10, model = 1)
simulation(n=3000, p = 5, L=5.3, hazardC=0.08, SNR=0.3, func='logexp',  times=10, model = 1)
simulation(n=3000, p = 5, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 2)
simulation(n=3000, p = 5, L=5.3, hazardC=0.08, SNR=0.3, func='id',  times=10, model = 2)
simulation(n=3000, p = 5, L=5.3, hazardC=0.08, SNR=0.3, func='logexp',  times=10, model = 2)

simulation(n=3000, p = 10, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 1)
simulation(n=3000, p = 10, L=5.3, hazardC=0.08, SNR=0.3, func='id',  times=10, model = 1)
simulation(n=3000, p = 10, L=5.3, hazardC=0.08, SNR=0.3, func='logexp',  times=10, model = 1)
simulation(n=3000, p = 10, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 2)
simulation(n=3000, p = 10, L=5.3, hazardC=0.08, SNR=0.3, func='id',  times=10, model = 2)
simulation(n=3000, p = 10, L=5.3, hazardC=0.08, SNR=0.3, func='logexp',  times=10, model = 2)

simulation(n=3000, p = 20, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 1)
simulation(n=3000, p = 20, L=5.3, hazardC=0.08, SNR=0.3, func='id',  times=10, model = 1)
simulation(n=3000, p = 20, L=5.3, hazardC=0.08, SNR=0.3, func='logexp',  times=10, model = 1)
simulation(n=3000, p = 20, L=190, hazardC=2.6*1e-3, SNR=0.3, func='exp',  times=10, model = 2)
simulation(n=3000, p = 20, L=5.3, hazardC=0.08, SNR=0.3, func='id',  times=10, model = 2)
simulation(n=3000, p = 20, L=5.3, hazardC=0.08, SNR=0.3, func='logexp',  times=10, model = 2)
...
# plot(sort(truth),truth[order(truth)],'l',xlim=c(min(truth)-(median(truth)-min(truth))*0.05, (max(truth)+(-median(truth)+max(truth))*0.05)), ylim=c(min(truth)-(median(truth)-min(truth))*0.05, (max(truth)+(-median(truth)+max(truth))*0.05)),col="red",  xlab="Truth", ylab="Pediction", main="Link:exp, model:1")
